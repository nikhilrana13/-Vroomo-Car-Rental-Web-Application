    ...
    return (
        <footer className="w-full bg-[#F5F5F5]">
            <div className="mx-auto  max-w-7xl ">
                {/*Grid*/}
                <div className="grid p-5 grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-5 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
                    <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                        ...
                        <p className="py-8 text-sm font-[500] text-[#465D7C] lg:max-w-xs  lg:text-left">
                            Vroomo is your ultimate car rental destination, designed to make your journeys smooth, simple, and affordable. Whether it’s a short trip, a weekend getaway, or a long vacation, Vroomo offers a wide range of cars to suit your style and budget.
                        </p>
                        <NavLink
                            to="#"
                ...
                <div className="py-7 p-5">
                    <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                        <span className="text-sm text-[#465D7C] dark:text-white  font-[500] ">
                            ©<NavLink href="/">Vroomo</NavLink> Made with ❤️ by Nikhil Rana
