...
const ProfileUpdate = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      setloading(true)
      const response = await axios.put(`${import.meta.env.VITE_BACKEND_URL}/api/user/update-profile`,formdata,{
        headers:{
  ...
  return (
    <div className="flex flex-col mx-auto w-full gap-5 p-10 border">
  {/* Back to home left */}
  <div className="w-full p-3 md:px-10 md:py-5 ">
  ...
  <div className="font-std max-w-[500px] mx-auto mb-10 w-full rounded-2xl bg-white p-10 font-normal leading-relaxed text-gray-900 shadow-xl">
